    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(text => {
            ...
            try {
                ...
                showMessage('Server error. Please ensure main.php is properly configured.', 'error');
            }
        })
        .catch(error => {
            console.error('Fetch Error:', error);
            showMessage('Unable to connect to server. Please check that main.php exists and is accessible.', 'error');
        })
        .finally(() => {
